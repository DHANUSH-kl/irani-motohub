            ...
            >
              {displayedProducts.map((product, idx) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className={`group flex flex-col bg-transparent flex-shrink-0 transition-all duration-300 ${
                    ...
                    >
                      ...
                      <div className="relative aspect-[4/5] w-full bg-[#F3F3F0] overflow-hidden">
                        ...
                        {soldOut ? (
                          <span className="absolute top-4 left-4 bg-brand-primary text-white text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 z-10">
                            SOLD OUT
                          </span>
                      ...
                      <div className="flex-grow flex flex-col pt-4 pb-4">
                        ...
                        <button
                          ...
                          className="w-full bg-[#1E1E1E] hover:bg-brand-red text-white py-3.5 font-headings text-xs font-bold uppercase tracking-widest transition-colors duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:hover:bg-[#1E1E1E]"
                        >
                          {soldOut ? (
                            "SOLD OUT"
                          ) : addingId === product.id ? (
