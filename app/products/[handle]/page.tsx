  ...
  useEffect(() => {
    const loadProduct = async () => {
      ...
      if (prodData) {
        ...
        // Fetch only related products of same category (not the entire catalog)
        const related = await getRelatedProducts(prodData.id, prodData.category, 4);
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="bg-white border border-brand-border p-6 md:p-8 rounded-xl space-y-5">
