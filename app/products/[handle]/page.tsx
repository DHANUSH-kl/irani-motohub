                ...
                {product.reviews.map((rev) => (
                  <div key={rev.id} className="py-6 first:pt-0 last:pb-0 space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-brand-muted text-xs font-semibold">{rev.date}</span>
                    </div>
                    
                    <h4 className="font-headings font-extrabold text-sm text-brand-primary uppercase">
                      {rev.title}
                    </h4>
                    
                    <p className="text-brand-muted text-xs leading-relaxed font-body italic">
                      &quot;{rev.comment}&quot;
                    </p>
                    
                    <span className="text-[10px] text-brand-primary font-bold uppercase block tracking-wider pt-1">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-24 space-y-6">
            <div className="bg-white border border-brand-border p-6 md:p-8 rounded-xl shadow-sm space-y-6">
              ...
              <div>
                ...
                <h1 className="text-2xl sm:text-3xl font-headings font-extrabold tracking-tight text-brand-primary leading-tight uppercase">
                  {product.title}
                </h1>
              ...
              {/* Dynamic Fitment/Compatibility Check Box */}
              <div className="border border-brand-border p-4 bg-brand-bg rounded-lg space-y-3">
                <span className="text-[10px] font-bold tracking-wider text-brand-primary uppercase flex items-center gap-1">
                  <Wrench className="w-3.5 h-3.5 text-brand-red" /> Fitment Check
                </span>
                <div className="grid grid-cols-2 gap-2">
                  <select
                    value={selectedMaker}
                    onChange={(e) => handleFitmentCheck(e.target.value, "")}
                    className="bg-white border border-brand-border rounded p-2 text-xs font-semibold text-brand-primary focus:outline-none focus:border-brand-primary"
                  >
                  ...
                  <select
                    ...
                    className="bg-white border border-brand-border rounded p-2 text-xs font-semibold text-brand-primary focus:outline-none focus:border-brand-primary disabled:opacity-50"
                  >
                ...
                {fitmentResult.status !== "idle" && (
                  <div className={`p-2.5 rounded text-[11px] font-bold tracking-wide leading-normal flex items-start gap-1.5 ${
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center border border-brand-border rounded bg-white">
                    <button
                      ...
                      className="px-3 py-2 text-brand-primary hover:bg-brand-bg transition-colors"
                    >
                      -
                    </button>
